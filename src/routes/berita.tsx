...
const NEWS = [
  {
    ...
    excerpt:
      "Panitia menutup pendaftaran gelombang akhir. Verifikasi berkas dilakukan maksimal 3 hari kerja.",
  },
  {
    tag: "Teknis",
    ...
    excerpt:
      "Gunakan laptop/PC dengan browser Chrome versi terbaru, RAM 4GB, dan koneksi minimal 5 Mbps.",
  },
  {
    tag: "Berita",
    ...
    excerpt:
      "Kerja sama mencakup penyediaan data pasar untuk soal analisis dan kunjungan pemenang ke gedung bursa.",
  },
  {
    tag: "Pengumuman",
    ...
    excerpt:
      "Silabus final memuat enam sub-tes materi beserta bobot nilai dan contoh soal analisis kasus.",
  },
  {
    tag: "Teknis",
    ...
    excerpt:
      "Peserta dapat mengakses trial exam kapan saja untuk membiasakan diri dengan palet soal dan timer.",
  },
  {
    tag: "Berita",
    ...
    excerpt:
      "Penambahan hadiah berasal dari sponsor baru, termasuk beasiswa sertifikasi analis efek.",
  },
];
    ...
    <PublicLayout>
      <section className="hero-teal grid-noise">
        <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-widest text-primary-foreground/80">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6">
        <article className="overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-card)]">
          <div className="grid gap-0 md:grid-cols-[1fr_1.4fr]">
            <div className="hero-teal grid-noise min-h-48 p-8">
              <span className="rounded-full bg-gold px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-teal-deepest">
                {HIGHLIGHT.tag}
              </span>
            ...
            <div className="p-8">
              <h2 className="text-2xl font-extrabold text-teal-deepest">{HIGHLIGHT.title}</h2>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {NEWS.map((n) => (
            <article
              key={n.title}
              className="card-accent flex flex-col rounded-xl border border-border bg-card p-6 transition-shadow hover:shadow-[var(--shadow-card)]"
            >
              ...
              <h3 className="mt-4 text-lg font-bold leading-snug text-teal-deepest">{n.title}</h3>
              <p className="mt-2 flex-1 text-sm leading-relaxed text-muted-foreground">
                {n.excerpt}
              </p>
              <button className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-cyan-teal hover:text-teal-deep">
